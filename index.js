    ...
    if(req.method === 'POST'){
       ...
       console.log('Request found with POST method');
        ...
        req.on('end', function () {
            ...
            // use POST
            res.end("Sent data are name:"+POST.q1+" value:"+POST.y);
...
function  getData(res,url_parts){
 ...
 console.log("Data submitted by the user:"+url_parts.query.q1+" and value:"+url_parts.query.y);
        res.end("Data submitted by the user:"+url_parts.query.q1+" and value:"+url_parts.query.y);
